...
export class WirelessNetworkPerformanceController extends BaseController {
  ...
  async nearRealTimeNetworkConditions(
    ...
    const req = this.createRequest(
      'POST',
      '/v1/intelligence/network-conditions'
    );
    req.baseUrl('M2M');
  ...
  async domestic4GAnd5gNationwideNetworkCoverage(
    ...
    const req = this.createRequest(
      'POST',
      '/v1/intelligence/wireless-coverage'
    );
    req.baseUrl('M2M');
    const mapped = req.prepareArgs({
  ...
  async siteProximity(
    ...
    const req = this.createRequest(
      'POST',
      '/v1/intelligence/site-proximity/action/list'
    );
    req.baseUrl('M2M');
    const mapped = req.prepareArgs({
      body: [body, getNetworkConditionsRequestSchema],
  ...
  async deviceExperience30daysHistory(
    ...
    const req = this.createRequest(
      'POST',
      '/v1/intelligence/device-experience/history/30-days'
    );
    req.baseUrl('M2M');
    const mapped = req.prepareArgs({
  ...
  async deviceExperienceBulkLatest(
    ...
    const req = this.createRequest(
      'POST',
      '/v1/intelligence/device-experience/bulk/latest'
    );
    req.baseUrl('M2M');
    const mapped = req.prepareArgs({
